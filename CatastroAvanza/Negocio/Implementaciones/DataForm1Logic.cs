...
namespace CatastroAvanza.Negocio.Implementaciones
{
    ...
    {        
        ...
        public DataForm1Model GetUsersById(string id)
        {
            ...
            DataForm1Model DataForm1Model = new DataForm1Model();

            var predio = _contexto.R1202169295Predios
                .Where(x => x.NUMERO_DEL_PREDIO == id)
                .DefaultIfEmpty(new R1_2021_69295_PREDIOS())
                .FirstOrDefault();
            ...
            DataForm1Model dataform =_mapper.MapDataAModel(predio, cantidadMejora, R1202169295Predios, R2202169295Construcciones, R1202066069Predios);
